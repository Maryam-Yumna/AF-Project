...
(function(global, factory) {
   ...
   */ var _createTrustedTypesPolicy = function _createTrustedTypesPolicy1(trustedTypes, document) {
     ...
     */ DOMPurify.removed = [];
        ...
        var DocumentFragment1 = window.DocumentFragment, HTMLTemplateElement1 = window.HTMLTemplateElement, Node1 = window.Node, Element1 = window.Element, NodeFilter1 = window.NodeFilter, _window$NamedNodeMap = window.NamedNodeMap, NamedNodeMap1 = _window$NamedNodeMap === undefined ? window.NamedNodeMap || window.MozNamedAttrMap : _window$NamedNodeMap, Text1 = window.Text, Comment1 = window.Comment, DOMParser1 = window.DOMParser, trustedTypes = window.trustedTypes;
     ...
     * of importing it into a new Document and returning a sanitized copy */ var IN_PLACE = false;
        ...
        /* Tags to ignore content of when KEEP_CONTENT is true */ var FORBID_CONTENTS = addToSet({
        }, [
            'annotation-xml',
            'audio',
            'colgroup',
     ...
     */ var _initDocument = function _initDocument1(dirty) {
       ...
       */ if (NAMESPACE === HTML_NAMESPACE) try {
                doc = new DOMParser1().parseFromString(dirtyPayload, 'text/html');
            } catch (_) {
            }
            ...
            /* Work on whole document or just its body */ return WHOLE_DOCUMENT ? doc.documentElement : body;
        };
        /**
     * _createIterator
     *
     ...
     */ var _isClobbered = function _isClobbered1(elm) {
            if (elm instanceof Text1 || elm instanceof Comment1) return false;
            if (typeof elm.nodeName !== 'string' || typeof elm.textContent !== 'string' || typeof elm.removeChild !== 'function' || !(elm.attributes instanceof NamedNodeMap1) || typeof elm.removeAttribute !== 'function' || typeof elm.setAttribute !== 'function' || typeof elm.namespaceURI !== 'string' || typeof elm.insertBefore !== 'function') return true;
            return false;
        };
        /**
     * _isNode
